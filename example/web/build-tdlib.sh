...
cd build/wasm
eval emcmake cmake -DCMAKE_BUILD_TYPE=MinSizeRel -j$nproc $OPENSSL_OPTIONS $TD_ROOT || exit 1
cd ../..

cd build/asmjs
eval emcmake cmake -DCMAKE_BUILD_TYPE=MinSizeRel -j$nproc $OPENSSL_OPTIONS -DASMJS=1 $TD_ROOT || exit 1
cd ../..
